    ...
    public function show(Request $request){
        ...
        if($validator != ""){
            ...
            $transacciones = Transaccion::Where('transaccion.user_id', '=', $request->input('user_id'))
                                ...
                                ->select('transaccion.id','transaccion.monto', 'transaccion.tipo_transaccion_id', 'transaccion.pivot_id_jugada', 'transaccion.observacion', 'transaccion.fecha_creacion')
                                ->orderBy('id', 'desc')
                                ->get();
